...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110251018687.jpg)
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110251052284.png)
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110251104368.png)
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110251120794.png)

当p的指针断开的时候，内部的引用形成一个循环，计数器都还算1，无法被回收，这就是循环引用，从而造成内存泄漏



### 4. 证明：java使用的不是引用计数算法
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110251209399.png)
...
```
Heap
 PSYoungGen      total 37888K, used 14178K [0x00000000d6600000, 0x00000000d9000000, 0x0000000100000000)
  eden space 32768K, 43% used [0x00000000d6600000,0x00000000d73d8b08,0x00000000d8600000)
...
```java
[GC (System.gc()) [PSYoungGen: 13523K->744K(37888K)] 13523K->752K(123904K), 0.0682280 secs] [Times: user=0.00 sys=0.00, real=0.07 secs] 
[Full GC (System.gc()) [PSYoungGen: 744K->0K(37888K)] [ParOldGen: 8K->626K(86016K)] 752K->626K(123904K), [Metaspace: 3282K->3282K(1056768K)], 0.0082303 secs] [Times: user=0.03 sys=0.00, real=0.01 secs] 
Heap
 ...
 ParOldGen       total 86016K, used 626K [0x0000000083200000, 0x0000000088600000, 0x00000000d6600000)
  object space 86016K, 0% used [0x0000000083200000,0x000000008329cb78,0x0000000088600000)
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110251217486.png)
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110251220454.png)
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110251248151.png)



### 4. 代码演示 finalize() 方法可复活对象

我们重写 Test 类的 finalize()方法，在调用其 finalize()方法时，将 obj 指向当前类对象 this
...
public class Test {
    ...
    public static Test obj; // 类变量，属于 GC Root
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110251328557.png)
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110251350276.png)

2、 生成 heapdump-1.hprof 文件，另存为保存即可

![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110251350184.png)

3、输入命令，继续执行程序

![](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211025134918140.png)

4、接着捕获第二张堆内存快照 heapdump-2.hprof
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110251355837.png)



3、第一次捕捉堆内存快照时，GC Roots 中包含我们定义的两个局部变量，类型分别为 ArrayList 和 Date，Total:21

![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110251358029.png)



4、打开第二个dump文件，第二次捕获内存快照时，由于两个局部变量引用的对象被释放，所以这两个局部变量不再作为 GC Roots ，从 Total Entries = 19 也可以看出（少了两个 GC Roots）

![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110251400694.png)



### 3. JProfiler GC Roots 溯源
...
1、打开 jprofiler，进行对象值的标记，颜色变为绿色

![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110251409096.png)



2、右击对象，选择 Show Selection In Heap Walker，单独的查看某个对象

![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110251412360.png)
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110251416379.png)
...
Dumping heap to java_pid14016.hprof ...
Heap dump file created [7763319 bytes in 0.022 secs]
count = 6
```
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110251425819.png)



2、揪出 main() 线程中出问题的代码

![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110251425894.png)
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110252137219.png)
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110252140969.png)
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110252141975.png)
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110252142780.png)
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110261109567.png)
