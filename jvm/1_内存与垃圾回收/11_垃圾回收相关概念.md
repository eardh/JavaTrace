...
//        System.runFinalization(); // 强制调用使用引用的对象的finalize()方法
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        System.out.println("Test 重写了 finalize()");
    }
}
```
...
```java
[GC (System.gc()) [PSYoungGen: 12867K->760K(37888K)] 12867K->11008K(123904K), 0.0119443 secs] [Times: user=0.02 sys=0.03, real=0.01 secs] 
[Full GC (System.gc()) [PSYoungGen: 760K->0K(37888K)] [ParOldGen: 10248K->10867K(86016K)] 11008K->10867K(123904K), [Metaspace: 3269K->3269K(1056768K)], 0.0085192 secs] [Times: user=0.00 sys=0.00, real=0.01 secs] 
Heap
 PSYoungGen      total 37888K, used 1638K [0x00000000d6600000, 0x00000000d9000000, 0x0000000100000000)
  eden space 32768K, 5% used [0x00000000d6600000,0x00000000d6799b40,0x00000000d8600000)
  from space 5120K, 0% used [0x00000000d8600000,0x00000000d8600000,0x00000000d8b00000)
  to   space 5120K, 0% used [0x00000000d8b00000,0x00000000d8b00000,0x00000000d9000000)
 ParOldGen       total 86016K, used 10867K [0x0000000083200000, 0x0000000088600000, 0x00000000d6600000)
  object space 86016K, 12% used [0x0000000083200000,0x0000000083c9cc98,0x0000000088600000)
...
```java
[GC (System.gc()) [PSYoungGen: 13523K->744K(37888K)] 13523K->752K(123904K), 0.0023366 secs] [Times: user=0.00 sys=0.00, real=0.00 secs] 
[Full GC (System.gc()) [PSYoungGen: 744K->0K(37888K)] [ParOldGen: 8K->652K(86016K)] 752K->652K(123904K), [Metaspace: 3296K->3296K(1056768K)], 0.0100342 secs] [Times: user=0.03 sys=0.00, real=0.01 secs] 
Heap
 PSYoungGen      total 37888K, used 328K [0x00000000d6600000, 0x00000000d9000000, 0x0000000100000000)
  ...
  from space 5120K, 0% used [0x00000000d8600000,0x00000000d8600000,0x00000000d8b00000)
  to   space 5120K, 0% used [0x00000000d8b00000,0x00000000d8b00000,0x00000000d9000000)
 ParOldGen       total 86016K, used 652K [0x0000000083200000, 0x0000000088600000, 0x00000000d6600000)
  object space 86016K, 0% used [0x0000000083200000,0x00000000832a3168,0x0000000088600000)
...
```java
[GC (System.gc()) [PSYoungGen: 13523K->744K(37888K)] 13523K->10992K(123904K), 0.0114733 secs] [Times: user=0.00 sys=0.00, real=0.01 secs] 
[Full GC (System.gc()) [PSYoungGen: 744K->0K(37888K)] [ParOldGen: 10248K->10892K(86016K)] 10992K->10892K(123904K), [Metaspace: 3297K->3297K(1056768K)], 0.0146664 secs] [Times: user=0.00 sys=0.00, real=0.02 secs] 
Heap
 PSYoungGen      total 37888K, used 328K [0x00000000d6600000, 0x00000000d9000000, 0x0000000100000000)
  eden space 32768K, 1% used [0x00000000d6600000,0x00000000d6652030,0x00000000d8600000)
  from space 5120K, 0% used [0x00000000d8600000,0x00000000d8600000,0x00000000d8b00000)
  to   space 5120K, 0% used [0x00000000d8b00000,0x00000000d8b00000,0x00000000d9000000)
 ParOldGen       total 86016K, used 10892K [0x0000000083200000, 0x0000000088600000, 0x00000000d6600000)
  object space 86016K, 12% used [0x0000000083200000,0x0000000083ca3178,0x0000000088600000)
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110261300539.png)
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110261301708.png)



3.  之后我们打开 IDE 编译后的字节码文件，在 IDE 反编译后，我们可以清楚的看到方法3在字节码中的方法体是这样的，说明前端编译器对代码进行了优化处理，局部代码块的括号消失，接着看下字节码文件，发现其新建了一个大小为 10485760 的数组，并且将其存储在了槽索引为1的位置，因此索引还在，不会被GC回收

![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110261301096.png)
...
```
[GC (System.gc()) [PSYoungGen: 13523K->744K(37888K)] 13523K->752K(123904K), 0.0023068 secs] [Times: user=0.05 sys=0.00, real=0.00 secs] 
[Full GC (System.gc()) [PSYoungGen: 744K->0K(37888K)] [ParOldGen: 8K->628K(86016K)] 752K->628K(123904K), [Metaspace: 3281K->3281K(1056768K)], 0.0097467 secs] [Times: user=0.00 sys=0.00, real=0.01 secs] 
Heap
 PSYoungGen      total 37888K, used 983K [0x00000000d6600000, 0x00000000d9000000, 0x0000000100000000)
  ...
  from space 5120K, 0% used [0x00000000d8600000,0x00000000d8600000,0x00000000d8b00000)
  to   space 5120K, 0% used [0x00000000d8b00000,0x00000000d8b00000,0x00000000d9000000)
 ParOldGen       total 86016K, used 628K [0x0000000083200000, 0x0000000088600000, 0x00000000d6600000)
  object space 86016K, 0% used [0x0000000083200000,0x000000008329d000,0x0000000088600000)
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110261301602.png)
...
```java
[GC (System.gc()) [PSYoungGen: 13523K->728K(37888K)] 13523K->10968K(123904K), 0.0150646 secs] [Times: user=0.02 sys=0.02, real=0.02 secs] 
[Full GC (System.gc()) [PSYoungGen: 728K->0K(37888K)] [ParOldGen: 10240K->10892K(86016K)] 10968K->10892K(123904K), [Metaspace: 3297K->3297K(1056768K)], 0.0100055 secs] [Times: user=0.03 sys=0.00, real=0.01 secs] 
[GC (System.gc()) [PSYoungGen: 0K->0K(37888K)] 10892K->10892K(123904K), 0.0018694 secs] [Times: user=0.00 sys=0.00, real=0.00 secs] 
[Full GC (System.gc()) [PSYoungGen: 0K->0K(37888K)] [ParOldGen: 10892K->652K(86016K)] 10892K->652K(123904K), [Metaspace: 3297K->3297K(1056768K)], 0.0095551 secs] [Times: user=0.05 sys=0.00, real=0.01 secs] 
Heap
 PSYoungGen      total 37888K, used 328K [0x00000000d6600000, 0x00000000d9000000, 0x0000000100000000)
  eden space 32768K, 1% used [0x00000000d6600000,0x00000000d6652030,0x00000000d8600000)
...
- :small_airplane: 这里面隐含着一层意思是，在抛出OutofMemoryError之前，通常垃圾收集器会被触发，尽其所能去清理出空间。

  - :small_orange_diamond: 例如：在引用机制分析中，涉及到JVM会去尝试**回收软引用指向的对象**等。

  - :small_orange_diamond: 在java.nio.Bits.reserveMemory()方法中，我们能清楚的看到，System.gc()会被调用，以清理空间。

- :small_airplane: 当然，也不是在任何情况下垃圾收集器都会被触发的
  - :small_orange_diamond: 比如，我们去分配一个超大对象，类似一个超大数组超过堆的最大值，JVM可以判断出垃圾收集并不能解决这个问题，所以直接抛出OutofMemoryError。
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110261327559.png)
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110261348061.png)
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110261352883.png)
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110261358014.png)
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110261401817.png)
...
1、一般的垃圾回收算法至少会划分出两S个年代，年轻代和老年代。但是单纯的分代理论在垃圾回收的时候存在一个巨大的缺陷：为了找到年轻代中的存活对象，却不得不遍历整个老年代，反过来也是一样的。

![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110272110968.png)
...
3、这种记录全部含跨代引用对象的实现方案，无论是空间占用还是维护成本都相当高昂。而在垃圾 收集的场景中，收集器只需要通过记忆集判断出某一块非收集区域是否存在有指向了收集区域的指针就可以了，并不需要了解这些跨代指针的全部细节。那设计者在实现记忆集的时候，便可以选择更为 粗犷的记录粒度来节省记忆集的存储和维护成本，下面列举了一些可供选择（当然也可以选择这个范 围以外的）的记录精度：
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110261624899.png)
...
4.  🤍**虚引用（PhantomReference）**：一个对象是否有虚引用的存在，完全不会对其生存时间构成影响，也无法通过虚引用来获得一个对象的实例。为一个对象设置虚引用关联的**唯一目的就是能在这个对象被收集器回收时收到一个系统通知**。
...
![](https://gitee.com/eardh/picture/raw/master/jvm_img/202110261646494.png)
...
```java
public class Test {
    public static Test obj; // 当前类对象的声明
    static ReferenceQueue<Test> phantomQueue; // 引用队列
        ...
        public void run() {
            while (true) {
                if (phantomQueue != null) {
                    PhantomReference<Test> objt = null;
                    try {
                        objt = (PhantomReference<Test>) phantomQueue.remove();
                    } catch (InterruptedException e) {
                        e.printStackTrace();
                    }
                    if (objt != null) {
                        System.out.println("追踪垃圾回收过程：Test实例被GC了");
                    }
                }
            }
        }
    ...
    public static void main(String[] args) {
        ...
        obj = new Test();
        // 构造了 Test 对象的虚引用，并指定了引用队列
        PhantomReference<Test> phantomRef = new PhantomReference<>(obj, phantomQueue);
