...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231827202.jpeg)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231827145.jpeg)

该表不符合 1NF，因为规则说“表的每个属性必须具有原子（单个）值”，lisi和zhaoliu员工的 emp_mobile 值违反了该规则。为了使表符合 1NF ，我们应该有如下表数据：

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231827652.jpeg)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231827543.jpeg)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231827924.jpeg)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231827949.jpeg)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231827381.png)
...
员工的信息存储在 `employees` 表中，部门信息存储在 `departments` 表 中。通过 employees 表中的department_id字段与 departments 表建立关联关系。如果要查询一个员工所在部门的名称：
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231857443.jpeg)

商品信息表：

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231857547.jpeg)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231857017.jpeg)

**举例4：**

课程评论表 class_comment ，对应的字段名称及含义如下：

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231857598.jpeg)

学生表 student ，对应的字段名称及含义如下：

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231857356.jpeg)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231857986.png)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231857126.png)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231857705.jpeg)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231858266.png)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231858099.png)

进货表：

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231858741.png)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231858589.png)

进货单明细表：

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231858024.png)

商品信息表：

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231858177.png)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231858149.png)

商品信息表：

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231858170.png)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231858049.png)

供货单头表：

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231859527.png)
...
我们设计的案例是`电商业务`，由于电商业务太过庞大且复杂，所以我们做了业务简化，比如针对 SKU（StockKeepingUnit，库存量单位）和SPU（Standard Product Unit，标准化产品单元）的含义上，我们直接使用了SKU，并没有提及SPU的概念。本次电商业务设计总共有8个实体，如下所示。
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231859338.jpeg)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231859418.jpeg)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231859312.jpeg)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231859414.png)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231859204.png)

点击上面的 ok，即可出现下图左边的概念模型1，可以自定义概念模型的名字，在概念模型中使用最多的就是如图所示的Entity(实体)， Relationship(关系)

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231900962.jpeg)

**Entity实体**

选中右边框中Entity这个功能，即可出现下面这个方框，需要注意的是书写name的时候，code自行补全，name可以是英文的也可以是中文的，但是code必须是英文的。

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231900261.jpeg)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231900327.jpeg)

在此上图说明name和code的起名方法

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231900368.jpeg)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231900611.jpeg)

**放大模型**

创建好概念数据模型如图所示，但是创建好的字体很小，读者可以按着ctrl键同时滑动鼠标的可滑动按钮即可放大缩写字体，同时也可以看到主标识符有一个\*号的标志，同时也显示出来了，name,Data type和length这些可见的属性

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231900768.jpeg)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231901298.jpeg)

创建好主页面如图所示，但是右边的按钮和概念模型略有差别，物理模型最常用的三个是`table(表)`， `view(视图) `，` reference(关系) `；

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231901642.jpeg)

鼠标先点击右边table这个按钮然后在新建的物理模型点一下，即可新建一个表，然后双击新建如下图所示，在General的name和code填上自己需要的，点击应用即可），如下图：

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231901342.jpeg)

然后点击Columns,如下图设置，非常简单，需要注意的就是P（primary主键） , F（foreign key外键） , M（mandatory强制性的，代表不可为空） 这三个。

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231901531.jpeg)

在此设置学号的自增（MYSQL里面的自增是这个AUTO_INCREMENT），班级编号同理，不多赘述！

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231901165.jpeg)

在下面的这个点上对号即可，就设置好了自增

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231901921.jpeg)

全部完成后如下图所示。

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231901955.jpeg)

班级物理模型同理如下图所示创建即可

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231901582.png)

完成后如下图所示

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231902249.jpeg)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231902353.jpeg)

做完上面的操作，就可以双击中间的一条线，显示如下图，修改name和code即可

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231902319.jpeg)

但是需要注意的是，修改完毕后显示的结果却如下图所示，并没有办法直接像概念模型那样，修改过后显示在中间的那条线上面，自己明白即可。

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231902201.jpeg)

学习了多对一或者一对多的关系，接下来学习多对对的关系，同理自己建好老师表，这里不在叙述，记得老师编号自增，建好如下图所示

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231902292.jpeg)

下面是多对多关系的关键，由于物理模型多对多的关系需要一个中间表来连接，如下图，只设置一个字段，主键，自增

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231902666.jpeg)

点击应用，然后设置Columns，只添加一个字段

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231902632.jpeg)

这是设置字段递增，前面已经叙述过好几次

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231902905.jpeg)

设置好后如下图所示，需要注意的是有箭头的一方是一，无箭头的一方是多，即一对多的多对一的关系需要搞清楚，学生也可以有很多老师，老师也可以有很多学生，所以学生和老师都可以是主体；

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231902153.jpeg)

可以看到添加关系以后学生和教师的关系表前后发生的变化

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231902731.jpeg)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231902346.jpeg)

点开的页面如下所示，name和code已经从概念模型1改成物理模型1了

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231902541.jpeg)

完成后如下图所示，将自行打开修改的物理模型，需要注意的是这些表的数据类型已经自行改变了，而且中间表出现两个主键，即双主键，

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231902672.jpeg)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231902679.jpeg)

然后出现如下图所示界面，然后将物理修改为概念 ，点击应用确认即可

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231903255.jpeg)

点击确认后将自行打开如下图所示的页面，自己观察有何变化，如果转换为oracle的，数据类型会发生变化，比如Varchar2等等）；

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231903794.jpeg)
...
![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231903503.jpeg)

打开之后如图所示，修改好存在sql语句的位置和生成文件的名称即可

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231903647.jpeg)

在Selection中选择需要导出的表，然后点击应用和确认即可

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231903130.jpeg)

完成以后出现如下图所示，可以点击Edit或者close按钮

![](https://gitlab.com/eardh/picture/-/raw/main/mysql_img/202203231903755.jpeg)
