...
- ![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162211496.png)

- 小南、小女（线程）来使用这个算盘来进行一些计算，并按照时间给老王支付费用
- 但小南不能一天24小时使用算盘，他经常要小憩一会（sleep），又或是去吃饭上厕所（阻塞 io 操作），有 时还需要一根烟，没烟时思路全无（wait）这些情况统称为（阻塞）

- ![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162211433.png)
...
- 计算流程是这样的
- ![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162211853.png)
...
- ![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162211419.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162211534.png)

如果是单线程以上 8 行代码是顺序执行（不会交错）没有问题：

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162212941.png)

但多线程下这 8 行代码可能交错运行： 

出现负数的情况：

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162212532.png)

出现正数的情况：

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162212998.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162212006.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162213237.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162213824.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162213911.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162213503.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162214027.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162215721.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162215914.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162215632.png)

- 让锁记录中的 Object reference 指向对象，并且尝试用 cas(compare and sweep) 替换 Object 对象的 Mark Word ，将 Mark Word 的值存入锁记录中

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162216614.png)

- 如果cas替换成功，那么对象的对象头储存的就是 `锁记录的地址和状态 01`，如下所示

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162216794.png)

- 如果cas失败，有两种情况
  - 如果是其它线程已经持有了该Object的轻量级锁，那么表示有竞争，将进入锁膨胀阶段
  - 如果是自己的线程已经执行了synchronized进行加锁，那么那么再添加一条 Lock Record 作为重入的计数

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162216187.png)

- 当线程退出synchronized代码块的时候，**如果获取的是取值为 null 的锁记录 **，表示有重入，这时重置锁记录，表示重入计数减一

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162216165.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162216892.png)

- 这时 Thread-1 加轻量级锁失败，进入锁膨胀流程
  - 即为对象申请Monitor锁，让Object指向重量级锁地址
  - 然后自己进入Monitor 的EntryList 变成BLOCKED状态

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162216341.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162216868.png)



2. 自旋重试失败的情况，自旋了一定次数还是没有等到持锁的线程释放锁

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162216919.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162216770.png)



**1、偏向状态**

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162217193.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162217924.png)

- 于是老王单开了一间休息室（调用 wait 方法），让小南到休息室（WaitSet）等着去了，但这时锁释放开， 其它人可以由老王随机安排进屋
- 直到小M将烟送来，大叫一声 [ 你的烟到了 ] （调用 notify 方法）

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162217669.png)

- 小南于是可以离开休息室，重新进入竞争锁的队列

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162217572.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162217983.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162218253.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162218447.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162218474.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162218347.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162218297.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162219826.png)
...
- **当前线程**调用 `LockSupport.parkNanos(long nanos)` 或 `LockSupport.parkUntil(long millis)` 时，当前线 程从 `RUNNABLE --> TIMED_WAITING`
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162219109.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162219659.png)

顺序加锁的解决方案

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111162220899.png)
