...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192108696.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192110814.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192110820.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192111092.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192111786.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192112277.png)
...
# 结果
# 有注释
12:53:38.922 c.TestDeadLock [pool-1-thread-1] - 处理点餐...
12:53:38.930 c.TestDeadLock [pool-1-thread-2] - 做菜
12:53:38.931 c.TestDeadLock [pool-1-thread-1] - 上菜: 地三鲜

# 没注释
12:55:06.855 c.TestDeadLock [pool-1-thread-1] - 处理点餐...
12:55:06.910 c.TestDeadLock [pool-1-thread-2] - 处理点餐...
```
...
```shell
# 结果
12:56:27.751 c.TestDeadLock [pool-1-thread-1] - 处理点餐...
12:56:27.778 c.TestDeadLock [pool-2-thread-1] - 做菜
12:56:27.779 c.TestDeadLock [pool-1-thread-1] - 上菜: 辣子鸡丁
12:56:27.785 c.TestDeadLock [pool-1-thread-1] - 处理点餐...
12:56:27.786 c.TestDeadLock [pool-2-thread-1] - 做菜
12:56:27.786 c.TestDeadLock [pool-1-thread-1] - 上菜: 辣子鸡丁
```
...
并行度并不高，后一步依赖于上一步的结果，如图：

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192112058.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192112055.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192113772.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192113569.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192114212.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192114316.png)

第一个竞争出现时

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192114141.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192114144.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192115147.png)

4. shouldParkAfterFailedAcquire 执行完毕回到 acquireQueued ，再次 tryAcquire 尝试获取锁，当然这时 state 仍为 1，失败
5. 当再次进入 shouldParkAfterFailedAcquire 时，这时因为其前驱 node 的 waitStatus 已经是 -1，这次返回 true
6. 进入 parkAndCheckInterrupt， Thread-1 park（灰色表示）

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192115943.png)

再次有多个线程经历上述过程竞争失败，变成这个样子

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192115320.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192115074.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192116932.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192116670.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192117740.png)

接下来进入 AQS 的 fullyRelease 流程，释放同步器上的锁

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192117233.png)

unpark AQS 队列中的下一个节点，竞争锁，假设没有其他竞争线程，那么 Thread-1 竞争成功

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192117556.png)

park 阻塞 Thread-0

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192117613.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192117895.png)

进入 ConditionObject 的 doSignal 流程，取得等待队列中第一个 Node，即 Thread-0 所在 Node

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192118465.png)

执行 transferForSignal 流程，将该 Node 加入 AQS 队列尾部，将 Thread-0 的 waitStatus 改为 0，Thread-3 的 waitStatus 改为 -1

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192118818.png)
...
```shell
# 结果
13:12:41.852 c.DataContainer [t1] - 获取读锁...
13:12:41.849 c.DataContainer [t2] - 获取读锁...
13:12:41.856 c.DataContainer [t1] - 读取
13:12:41.856 c.DataContainer [t2] - 读取
13:12:42.863 c.DataContainer [t1] - 释放读锁...
13:12:42.863 c.DataContainer [t2] - 释放读锁...
```
...
```shell
# 结果
13:15:04.422 c.DataContainer [t1] - 获取读锁...
13:15:04.437 c.DataContainer [t1] - 读取
13:15:04.534 c.DataContainer [t2] - 获取写锁...
13:15:05.453 c.DataContainer [t1] - 释放读锁...
13:15:05.453 c.DataContainer [t2] - 写入
13:15:06.465 c.DataContainer [t2] - 释放写锁...
```
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192118447.png)

先更新数据库

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192119161.png)

补充一种情况，假设查询线程 A 查询数据时恰好缓存数据由于时间到期失效，或是第一次查询

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192119045.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192119420.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192119025.png)

3. 这时会进入 sync.doAcquireShared(1) 流程，首先也是调用 addWaiter 添加节点，不同之处在于节点被设置为 Node.SHARED 模式而非 Node.EXCLUSIVE 模式，注意此时 t2 仍处于活跃状态

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192120116.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192120867.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192120949.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192120313.png)

接下来执行唤醒流程 sync.unparkSuccessor，即让老二恢复运行，这时 t2 在 doAcquireShared 内 parkAndCheckInterrupt() 处恢复运行

这回再来一次 for (;;) 执行 tryAcquireShared 成功则让读锁计数加一

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192121503.png)

这时 t2 已经恢复运行，接下来 t2 调用 setHeadAndPropagate(node, 1)，它原本所在节点被置为头节点

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192121768.png)

事情还没完，在 setHeadAndPropagate 方法内还会检查下一个节点是否是 shared，如果是则调用 doReleaseShared() 将 head 的状态从 -1 改为 0 并唤醒老二，这时 t3 在 doAcquireShared 内 parkAndCheckInterrupt() 处恢复运行

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192121689.png)

这回再来一次 for (;;) 执行 tryAcquireShared 成功则让读锁计数加一

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192121313.png)

这时 t3 已经恢复运行，接下来 t3 调用 setHeadAndPropagate(node, 1)，它原本所在节点被置为头节点

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192122322.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192122000.png)

t3 进入 sync.releaseShared(1) 中，调用 tryReleaseShared(1) 让计数减一，这回计数为零了，进入 doReleaseShared() 将头节点从 -1 改为 0 并唤醒老二，即

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192122937.png)

之后 t4 在 acquireQueued 中 parkAndCheckInterrupt 处恢复运行，再次 for (;;) 这次自己是老二，并且没有其他 竞争，tryAcquire(1) 成功，修改头结点，流程结束

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192122320.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192123391.png)

假设其中 Thread-1，Thread-2，Thread-4 cas 竞争成功，而 Thread-0 和 Thread-3 竞争失败，进入 AQS 队列 park 阻塞

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192123041.png)

这时 Thread-4 释放了 permits，状态如下

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192123771.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192123761.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192123691.png)



**3. 产生 bug 的情况**

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192124468.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192124885.png)
...
{name=中通快递, id=1}
19:30:09.653 c.TestCountDownLatch [main] - 执行完毕
```
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192124230.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192126808.png)

结果再与 this.segmentMask 做位于运算，最终得到 1010 即下标为 10 的 segment

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111192126653.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111201207839.png)

当一个节点入队 `last = last.next = node;`

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111201208470.png)

再来一个节点入队 `last = last.next = node;`

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111201209308.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111201209302.png)

`first = h.next`

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111201209560.png)

`h.next = h`

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111201209223.png)

`head = first`

![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111201210226.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111201210476.png)
...
#### ![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111201412346.png)
...
![](https://gitee.com/eardh/picture/raw/master/Jconcurrent_img/202111201211933.png)
